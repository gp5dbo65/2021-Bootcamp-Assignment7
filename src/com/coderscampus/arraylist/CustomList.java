...
public interface CustomList<T> {
	 ...
	 * if the item was not successfully added (note: it should always be able to add 
	 * an item to the list) 
	 *
	 */
	boolean add (T item);
	 ...
	 * doesn't yet exist, then you should throw an <code>IndexOutOfBoundsException</code>.
	 * @param index the spot in the zero-based aray where you'd like to insert your new item
